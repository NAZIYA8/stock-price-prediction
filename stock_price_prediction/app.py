...
app = Flask(__name__)
model = LinearRegressionModel.load("hdfs://localhost:9000/stock_price_data_model")
data = spark.read.parquet("/home/naziya/Downloads/stock_price_prediction/testdata1")
